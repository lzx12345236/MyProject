...
train_pipeline = [
    dict(type='UniformSampleFrames', clip_len=175),
...
val_pipeline = [
    dict(type='UniformSampleFrames', clip_len=175, num_clips=1),
    dict(type='PoseDecode'),
    dict(type='PoseCompact', hw_ratio=1., allow_imgpad=True),
...
log_config = dict(interval=194, hooks=[dict(type='TextLoggerHook')])
log_level = 'INFO'
